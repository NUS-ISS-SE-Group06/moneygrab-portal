...
const ManageCurrencyCodeCreateModal = ({moneychanger,onClose, onCreated}) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await api.post(`/api/v1/money-changers-currencies`, payload);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl border border-purple-100 p-10 w-full max-w-xl relative animate-fade-in">
        <button
          ...
          aria-label="Close"
        >×</button>
        <h2 className="text-2xl font-bold mb-3 text-gray-900">Set New Currency Code</h2>
...
ManageCurrencyCodeCreateModal.propTypes = {
  moneychanger: PropTypes.object.isRequired,
  onClose: PropTypes.func.isRequired,
  onCreated: PropTypes.func.isRequired
}

export default ManageCurrencyCodeCreateModal;