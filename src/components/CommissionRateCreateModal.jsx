...
const CommissionRateCreateModal = ({ onClose, onCreated, schemeId, nameTag}) => {
  const [userId, setUserId] = useState(1);
  const [nameTag, setNameTag] = useState(nameTag);
  const [schemeId, setSchemeId] = useState(schemeId);
